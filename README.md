## 本文仅供学习参考
### 手把手简易VPN搭建教程 图文教程搭建一个vpn访问墙外的世界

### 准备工作：有支付宝账户（也支持微信），有一个可用邮箱，有10美元（人民币六七十块）。
...
第一步：登录vultr官网注册一个账户，只需要一个邮箱和密码即可。然后到你注册的邮箱中去验证你的账户。官网链接(https://www.vultr.com/?ref=7458400)
